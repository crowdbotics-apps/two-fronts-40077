"""
Django settings for two_fronts_40077 project.
...
ROOT_URLCONF = 'two_fronts_40077.urls'
...
WSGI_APPLICATION = 'two_fronts_40077.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static'), os.path.join(BASE_DIR, 'web_build'), os.path.join(BASE_DIR, 'web_build/frontend1/static'), os.path.join(BASE_DIR, 'web_build/frontend2/static')]
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "two_fronts_40077 API",
    "DESCRIPTION": "API documentation for two_fronts_40077 App",
    "VERSION": "v1",
}
